...
from cryptofeed.defines import L2_BOOK, L3_BOOK, MARKET_INFO, TRADES, TICKER, FUNDING, OPEN_INTEREST
    ...
    def read(self, exchange, dtype, pair, start=None, end=None):
        ...
        for message in data:
            ...
            if dtype in {L2_BOOK, L3_BOOK}:
                ...
                ret.extend(update)
            if dtype in {MARKET_INFO, TRADES, TICKER, FUNDING, OPEN_INTEREST}:
                ret.append(update)
